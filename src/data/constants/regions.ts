...
export const REGION_DATA: RegionData = {
    seoul: [
        ...
        { id: 'geumcheon', name: '금천구', x: 60, y: 315 },
        { id: 'gwanak', name: '관악구', x: 115, y: 310 },
    ],
    busan: [
        ...
        { id: 'busanjin', name: '부산진구', x: 145, y: 165 },
    ...
    jeonnam: [
        { id: 'yeonggwang', name: '영광군', x: 40, y: 50 },
    ...
    gyeongnam: [
        ...
        { id: 'goseong', name: '고성군', x: 150, y: 230 },
